...
| `multiway/ollivier_ricci.rs`, `wasserstein.rs` | `κ(x,y) = 1 − W₁(μ_x, μ_y)/d(x,y)` with uniform neighbor measures; `W₁` by transportation simplex | [Oll09] (definition), [Vil03] (optimal transport / `W₁`) | [Oll09] cache-verified (Def 3, 2026-08-17); [Vil03] (†) |
