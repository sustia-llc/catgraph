...
- `multiway::ollivier_ricci::all_pairs_bfs` compiles on every feature lane and
  backs new unit pins: curvature and all-pairs differentials over the seeded
  topology fixtures now shared through `multiway::test_topologies`, plus a
  rayon-versus-sequential `multiway_betweenness` comparison
