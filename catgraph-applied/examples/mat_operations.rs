...
/// `mat_f64` bridge demonstration over the fixture `[[1,2,0], [0,3,4], [5,0,6]]`
/// and a rank-deficient 3×3: `mat_to_nalgebra`, `determinant`, `MatR::trace`,
/// `solve`, `one_norm`, `frobenius_norm`, `try_inverse`, `mat_from_nalgebra`
/// and `rank`.
#[cfg(feature = "f64-rig")]
fn run_mat_f64_demo() {
