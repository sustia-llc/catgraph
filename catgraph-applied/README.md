...
| `mat_f64` (feature `f64-rig`) | nalgebra bridge for `MatR<F64Rig>`: determinant, inverse, `solve` (`a ; x = b` by LU), SVD rank, induced 1-norm, Frobenius norm, `DMatrix` roundtrip |
