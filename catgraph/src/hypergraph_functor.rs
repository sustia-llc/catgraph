...
use crate::{
    cospan::Cospan, cospan_algebra::cospan_to_frobenius, errors::CatgraphError,
    frobenius::FrobeniusMorphism, hypergraph_category::HypergraphCategory,
};
...
impl<L1, L2, F> HypergraphFunctor<L1, L2, Cospan<L1>, Cospan<L2>> for RelabelingFunctor<F>
where
    L1: Eq + Copy + Debug,
    L2: Eq + Copy + Debug,
    F: Fn(L1) -> L2,
...
impl<Lambda, BlackBoxLabel>
    HypergraphFunctor<Lambda, Lambda, Cospan<Lambda>, FrobeniusMorphism<Lambda, BlackBoxLabel>>
