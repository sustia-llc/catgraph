...
| Prop 3.8: Cospan ≃ theory of special commutative Frobenius monoids | ✅ | cospan_algebra.rs::cospan_to_frobenius + hypergraph_functor.rs::CospanToFrobeniusFunctor + cospan_canon.rs::CospanCanon | post-audit: CospanCanon / Cospan::canonical_form (#100, read surface #254, from_parts/to_cospan round-trip #261) give the decidable cospan-equality-up-to-apex-iso that Cospan_Λ's morphisms (iso classes) are stated over |
