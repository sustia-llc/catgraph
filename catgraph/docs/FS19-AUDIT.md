...
| Eq 13: zigzag identities | ✅ | tests/compact_closed.rs | tested; content-pinned against `Cospan` canonical forms since [#284](https://github.com/sustia-llc/catgraph/issues/284) — before that the suite asserted interfaces only |
...
| Item | Status | catgraph location | Notes |
|---|---|---|---|
| Thm 4.13: Hyp_OF(Λ) ≃ Lax(Cospan_Λ, Set) | ✅ | equivalence.rs + tests/equivalence.rs | roundtrip verified for PartitionAlgebra and NameAlgebra |
