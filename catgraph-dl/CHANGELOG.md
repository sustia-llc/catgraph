...
- `Free::fold` and `Cofree::unfold` rustdoc narrowed to the pinned claim —
  position order of the children's results; the evaluation-order clause was
  dropped as unpinned, not as wrong
