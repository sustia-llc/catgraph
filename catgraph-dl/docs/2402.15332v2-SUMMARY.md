# CDL ICML 2024 — Merged Primer (catgraph-dl v0.2.0+)

> **Paper:** Gavranović\*, Lessard\*, Dudzik\*, von Glehn, Araújo, Veličković, *Categorical Deep Learning is an Algebraic Theory of All Architectures* ([arXiv:2402.15332v2](https://arxiv.org/abs/2402.15332), 6 Jun 2024; ICML 2024 PMLR 235:15209-15241; in-tree at [`2402.15332v2.pdf`](2402.15332v2.pdf)).
>
...
>
> **Status (workspace CLAUDE.md release rule 7).** This SUMMARY.md is the locked primer for the agent paper-audit reviewer briefed against the catgraph-dl source tree. The CDL paper anchor `2402.15332v2.pdf` is 539 KB — well below the ~10 MB hybrid paper-audit refinement threshold — so the reviewer also has direct cold-read access to the PDF. This primer pre-encodes (a) the published-paper section coverage, (b) the transcript-vs-paper provenance distinction, and (c) two ⚠️ CAREFUL caveats on Appendix H worked-example arithmetic that the reviewer should not re-derive from scratch.
>
> **Companion artefacts in this directory:**
> - [`2402.15332v2.pdf`](2402.15332v2.pdf) — the paper itself.
> - [`2402.15332v2-AUDIT.md`](2402.15332v2-AUDIT.md) — the v0.2.0 paper-coverage audit (76 audited items, 84% DONE on the implementable surface).
>
> **Companion artefacts in the workspace `.claude/` umbrella:**
> - `.claude/docs/2026-05-06-catgraph-dl-v0.3.0-design.md` — the v0.3.0 design phase doc (three flagged surfaces + Hopf-fibration evidence-note update).
>
> ---
...
| Citation, theorem statements, formal definitions, Haskell types, architecture diagrams | **Part II** (faithful paper rendering with appendices A/B/C/H/I/J/K) |
...
The paper says GDL fails for non-invertible computation but doesn't supply a concrete, ML-relevant example. The transcript provides one — pathfinding algorithms — directly aligned with `tsondru/catgraph` interests.
...
- **Concrete Haskell types** for all data structures (Appendix K)
...
16. [Appendix K: Consolidated Haskell Data Types & Cells](#appendix-k-consolidated-haskell-data-types--cells)
